import { sectionDataID10 } from "../../ArticleDatas/ID/ArticleDataID";
import { sectionDataEN10 } from "../../ArticleDatas/EN/ArticleDataEN";

const Section10 = ({ language = "en" }) => {
  const className = {
    ...
    <div className={className.container}>
      <div className={className.titleBox}>
        <div className={className.spacingBox}>
          <h2 className={className.section_1}>Section 10</h2>
          <h1 className={className.title}>
            {(language === "en" ? sectionDataEN10 : sectionDataID10).title}
          </h1>
        </div>
      </div>
      <div className={className.imageBox}>
        <img
          loading={"lazy"}
          src={(language === "en" ? sectionDataEN10 : sectionDataID10).image}
      ...
      <div className={className.descriptionsBox}>
        <p className={className.description}>
          <br />
          {(language === "en" ? sectionDataEN10 : sectionDataID10).opening}
        </p>
      </div>
    </div>
  );
