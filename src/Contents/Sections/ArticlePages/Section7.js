import { sectionDataID7 } from "../../ArticleDatas/ID/ArticleDataID";
import { sectionDataEN7 } from "../../ArticleDatas/EN/ArticleDataEN";
    ...
    <div className={className.container}>
      <div className={className.titleBox}>
        <div className={className.spacingBox}>
          <h2 className={className.section_1}>Section 7</h2>
          <h1 className={className.title}>
            {(language === "en" ? sectionDataEN7 : sectionDataID7).title}
          </h1>
        </div>
      </div>
      <div className={className.imageBox}>
        <img
          loading={"lazy"}
          src={(language === "en" ? sectionDataEN7 : sectionDataID7).image}
      ...
      <div className={className.descriptionsBox}>
        <p className={className.description}>
          <strong>
            {(language === "en" ? sectionDataEN7 : sectionDataID7).openingTitle}
          </strong>
          <br />
          <br />
          {(language === "en" ? sectionDataEN7 : sectionDataID7).opening}
        </p>
      </div>
    </div>
  );
