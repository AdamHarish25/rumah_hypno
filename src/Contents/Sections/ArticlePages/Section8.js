import { sectionDataID8 } from "../../ArticleDatas/ID/ArticleDataID";
import { sectionDataEN8 } from "../../ArticleDatas/EN/ArticleDataEN";

const Section8 = ({ language = "en" }) => {
  const className = {
    ...
    <div className={className.container}>
      <div className={className.titleBox}>
        <div className={className.spacingBox}>
          <h2 className={className.section_1}>Section 8</h2>
          <h1 className={className.title}>
            {(language === "en" ? sectionDataEN8 : sectionDataID8).title}
          </h1>
        </div>
      </div>
      <div className={className.imageBox}>
        <img
          loading={"lazy"}
          src={(language === "en" ? sectionDataEN8 : sectionDataID8).image}
      ...
      <div className={className.descriptionsBox}>
        <p className={className.description}>
          <br />
          {(language === "en" ? sectionDataEN8 : sectionDataID8).opening}
        </p>
      </div>
    </div>
  );
