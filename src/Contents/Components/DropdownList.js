...
const DropdownList = ({ title, content }) => {
  const className = {
    ...
    dropdownBox: `w-[500px] group-hover:h-fit group-hover:visible group-hover:p-10 invisible h-0 p-0 transform duration-500 text-white bg-blue-500 rounded-tr-[90px] rounded-bl-[90px]`,
  };
