...
const sectionDataID3 = {
  ...
  c2: (
    <>
      <br />
      Fobia Sosial – ketakutan yang melibatkan orang lain atau situasi seperti:
...
const sectionDataID5 = {
  ...
  c1: `One of well-known female presenter in Indonesia, Dewi Hughes who has proven that she lost 80 kg in 15 months!
      In her opinion, if you only want to be thin, you will do everything possible without thinking. For example, you are busy making a list of the foods you eat and their don’ts, calorie limits, portions, and the frequency of how many times you eat them.
      Dewi Hughes uses the hypnotherapy method according to her ability so that the diet process she goes through runs consistently. Hypnoslimming had straighten out her mindset by changing her goal to live a healthier life instead of willing to be thin. She also said the determination to lose weight should not come  because of the desire to be thin.`,
};
...
const sectionDataID7 = {
  ...
  opening: `Without realizing it, much of today's adult behavior and personality is the result of how a person's childhood was. Many cases show that bad experiences in childhood make a person grow up to be a coward, insecure, stubborn adult, traumatized by something, or even other deviant behaviors.
      In an Inner Child healing session, the therapist will create a metaphoric story for change. Where the child can explore itself and mature. A story that can empower the child and allow free flow of expression and creativity. The subconscious aspect of the true self is creative and does not know the difference between fact and fantasy.
      So letting go and trusting the subconscious mind to take in the new story as real is essential. The only thing that gets in the way is the critical faculty of the analytical mind. All we need to do is command it to step aside and let the healing take place.
      `,
};
...
const sectionDataID8 = {
  ...
  opening: `Despite limited scientific evidence regarding its effectiveness, hypnotherapy is popular as a tool for stopping smoking. However, it is unclear whether hypnosis strengthens the will to cease the habit or if it lowers the desire to continue (Barnes, McRobbie, Dong, Walker, & Hartmann-Boyce, 2019).
...
const sectionDataID9 = {
  ...
  opening: `Insomnia is a condition when a person has difficulty sleeping or cannot sleep well, often wakes up during sleep, has difficulty initiating sleep, and cannot even achieve normal sleep quality. Insomnia most often occurs in the elderly which is influenced by factors of age, lifestyle, environment, and diet.
      Insomnia hypnotherapy is now widely used as a treatment method, one of which is a treatment for treating insomnia sufferers. Insomnia hypnotherapy works by entering a person's subconscious, then giving certain suggestions to help the healing process. The prevalence of insomnia in the elderly in 2014 in Indonesia was around 10%. In 2015 around 15% and in 2016 around 17%, meaning that approximately 28 million of the total 238 million Indonesian population suffer from insomnia. ( Dinkes, 2019)
      The state of relaxation after hypnosis can increase the client's sense of comfort while in bed, so that the client can easily fall asleep, a relaxed mind reduces the incidence of dreams, decreases the frequency of awakening and increases the total nighttime sleep. In addition to hypnotherapy factors, the therapist also provides self-hypnosis training to clients, self-hypnosis is self-hypnosis that can help clients achieve a relaxed state without being assisted by a therapist.
      `,
};
...
const sectionDataID10 = {
  ...
  opening: `While some scientists still regard hypnosis with mistrust, it has proven useful in clinical settings and insightful in research into mental processes such as “sensation, perception, learning, memory, and physiology” (Faymonville et al., 2006).
...
const footerInfosID = {
  name: "-Melanie-",
  website: "www.rumahhypno.com",
  tiktok: "Tiktok:@homehypnomelanie",
};

const footerContactsID = {
  c1: "Interested in joining a therapy session?",
  c2: "BOOKING NOW and GET PROMO!",
  contact: "Contact Admin: 08111555073",
  number: "08111555073",
};
